...
public class TestCase implements Locators{
	...
	public void startFirefox(){
	    ...
	    File FireXPath = new File(projectpath+"/tool/FireXPath-0.9.7.1.xpi");
	...
	public void changeiFrame(){		
        ...
        dragger.dragAndDropBy(ffwb.findElement(By.xpath(SILDER)), initialPoint.getX()+569, initialPoint.getY()).build().perform();
	...
	public void changeWindows(){
		...
		ffwb.findElement(By.xpath("//div[@id='sb_ifc0']")).sendKeys("selenium");
		ffwb.findElement(By.xpath("//input[@jsaction='sf.chk']")).submit();
